...
# Each instance variables are defined first and the instance of Movie class created.
the_third_man_story = "The most famous collaboration of the director Carol Reed \
    and the screenwriter Graham Greene has the structure of \
    a good suspense thriller and an atmosphere of baroque, macabre decadence.\
